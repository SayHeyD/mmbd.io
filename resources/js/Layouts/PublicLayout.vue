...
<template>
  <div class="flex flex-col justify-center items-center sm:flex sm:justify-center sm:items-center min-h-svh bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900">
    <Head :title="title" />
